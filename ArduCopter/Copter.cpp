...
void Copter::data_loop() {
    ...
    int16_t gps_velocity_x = (int16_t)(gps_velocity.x * 100);  // cm/s
...
void Copter::one_hz_loop() {
    ...
    if (!motors->armed()) {
        ...
        motors->set_frame_class_and_type((AP_Motors::motor_frame_class) g2.frame_class.get(),
